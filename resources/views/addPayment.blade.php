...
<head>
    ...
    <title>Payment for {{ $workshop->name }}</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <p><strong>Workshop Name:</strong> {{ $workshop->name }}</p>
                            <p><strong>Type:</strong> {{ $workshop->type }}</p>
                            <p><strong>Date:</strong> {{ \Carbon\Carbon::parse($workshop->date)->format('l, d F Y') }}</p>
                            <p><strong>Amount:</strong> Rp {{ number_format($workshop->price, 0, ',', '.') }}</p>
                        </div>
